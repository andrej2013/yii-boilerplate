...
EOS;
            ...
            $code = <<<EOS
                ...
                [
                    'format' => 'raw',
                    'attribute' => '$column->name',
                    'value' => Html::img(\$model->renderGoogleMap('$column->name', ['format' => \\andrej2013\yiiboilerplate\components\GoogleMap::IMAGE])),
                ]
EOS;
            return $code;
        }
...
GridView::widget([
            ...
            'panel'        => [                
                ...
                'before'  => Html::a('<span class="fa fa-plus"></span> ' . $new_label . ' ' . $relation_single_label, [
