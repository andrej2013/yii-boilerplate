...
$inlineScript = 'var gridViewKey = "<?= Inflector::camel2id(StringHelper::basename($generator->modelClass), '-', true) ?>";var gridSelectedRow="'.GridView::TYPE_SUCCESS.'";';
...
<div class="box box-<?= '<?php '; ?>echo \Yii::$app->params['style']['primary_color']; ?>">
    <div class="giiant-crud box-body <?= Inflector::camel2id(StringHelper::basename($generator->modelClass), '-', true) ?>-index">
        <div class="table-responsive">
            ...
            'heading' => '<h4 class="panel-title"><i class="fa fa-list-o"></i> '
                .<?= $generator->generateString(Inflector::pluralize(Inflector::camel2words(StringHelper::basename($generator->modelClass)))) ?> . '</h4>',
            'type' => Yii::$app->params['style']['primary_color'],
            'before' => ($searchModel->editable() && Yii::$app->getUser()
            ->can(Yii::$app->controller->module->id . '_' . Yii::$app->controller->id . '_create') ? Html::a('<i class="fa fa-plus"></i> ' . Yii::t('app',
            'New'), ['create'], [
            'class' => 'btn',
