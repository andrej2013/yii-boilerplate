        ...
        <table class="table table-bordered table-striped table-condensed">
            ...
            <?php foreach ($files as $file): ?>
                ...
                if ($file->operation === CodeFile::OP_OVERWRITE) {
                    $trClass = 'warning';
                } else if ($file->operation === CodeFile::OP_SKIP) {
                    $trClass = 'active';
                } else if ($file->operation === CodeFile::OP_CREATE) {
                    $trClass = 'success';
                } else {
                    $trClass = '';
                }
        ...
        <div class="modal-content">
            <div class="modal-header">
                ...
                <div class="btn-group pull-left">
                    <a class="modal-previous btn btn-xs btn-default" href="#" title="Previous File (Left Arrow)"><span
